...
sed -i 's/iDROPBEAR_BANNER=""/DROPBEAR_BANNER="\/etc\/issue.net"/g' /etc/default/dropbear
...
#wget -O /etc/iptables.up.rules "https://raw.githubusercontent.com/khungphat84/noname/master/v/iptables.up.rules"
...
wget https://raw.githubusercontent.com/khungphat84/noname/master/vnstat_php_frontend-1.5.1.tar.gz
...
# SELASAI SUDAH BOSS! ( Autoscript By-AnonymousVpn8 )
echo "========================================"  | tee -a log-install.txt
echo "Service Autoscript AnonymousVpn8 (AnonymousVpn8 SCRIPT 2018)"  | tee -a log-install.txt
echo "----------------------------------------"  | tee -a log-install.txt
echo ""  | tee -a log-install.txt
